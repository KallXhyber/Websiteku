...
function MyApp({ Component, pageProps: { session, ...pageProps } }) {
  ...
  const bodyStyle = { minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative', zIndex: 1 };
  const contentWrapperStyle = { flex: '1 0 auto' };

  return React.createElement(SessionProvider, { session: session },
