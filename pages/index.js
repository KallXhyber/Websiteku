...
export default function HomePage() {
  ...
  return React.createElement('div', {
    ...
    React.createElement(BannerSlider),
    ...
    React.createElement(motion.section, {
      ...
      React.createElement('p', { className: 'text-lg text-discord-gray max-w-2xl mx-auto' },
        'Solusi sewa PC Cloud performa tinggi untuk segala kebutuhan gaming dan produktivitas Anda. Siap pakai, tanpa lag, kapan saja dan di mana saja.'
      ),
    ...
    React.createElement('section', {},
      ...
      React.createElement(motion.div, { 
        ...
        React.createElement(motion.div, { 
          ...
          React.createElement('p', { className: 'text-discord-gray' }, 'Spesifikasi PC terbaru untuk pengalaman gaming tanpa kompromi.')
        ),
        React.createElement(motion.div, { 
          className: 'bg-black/20 border border-discord-darker p-8 rounded-lg text-center hover:border-discord-blurple transition-colors',
          variants: itemVariants
          ...
          React.createElement('p', { className: 'text-discord-gray' }, 'Mainkan game favoritmu dari perangkat apa saja, di mana saja.')
        ),
        React.createElement(motion.div, { 
          className: 'bg-black/20 border border-discord-darker p-8 rounded-lg text-center hover:border-discord-blurple transition-colors',
          variants: itemVariants
          ...
          React.createElement('p', { className: 'text-discord-gray' }, 'Pesan, bayar, dan PC Cloud siap digunakan dalam hitungan menit.')
        )
      )
    )
  );
